...
//	public final FloatArrayList cloudXyz = new FloatArrayList(); // lock for reading/writing cloud data
//	// Storage for rgb values of points in the cloud
//	public final IntArrayList cloudColor = new IntArrayList();
//
...
//	public float maxRenderDistance = Float.MAX_VALUE;
...
//	public float hfov = 0; //UtilAngle.radian(50);
//
...
//		synchronized (cloudXyz) {
//
//			cloudXyz.ensureCapacity(cloudXyz.size() + length*3);
//			cloudColor.ensureCapacity(cloudColor.size() + length);
//
//			for (int i = 0, idx = 0; i < length; i++) {
//				cloudXyz.add(pointsXYZ[idx++]);
//				cloudXyz.add(pointsXYZ[idx++]);
//				cloudXyz.add(pointsXYZ[idx++]);
//				cloudColor.add(pointsRGB[i]);
//			}
//		}
//	}
//
...
//			worldPt.x = cloudXyz.getFloat(pointIdx++);
//			worldPt.y = cloudXyz.getFloat(pointIdx++);
//			worldPt.z = cloudXyz.getFloat(pointIdx++);
//
