        ...
        try {
            ...
            for (int t = 0; t < 7; t++)
                for (int i = 0; i < 8; i++) {
                    ...
                    switch (t) {
                        case FIRE_CENTER -> str += "C";
                        case FIRE_VERTICAL -> str += "V";
                        case FIRE_NORTH -> str += "N";
                        case FIRE_HORIZONTAL -> str += "H";
                        case FIRE_EAST -> str += "E";
                        case FIRE_WEST -> str += "W";
                        case FIRE_SOUTH -> str += "S";
                    }
