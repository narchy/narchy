...
//        lastSeed = seed;
    ...
    private int buildZone(int x, int maxLength) {
        ...
        return switch (type) {
            case ODDS_STRAIGHT -> buildStraight(x, maxLength, false);
            case ODDS_HILL_STRAIGHT -> buildHillStraight(x, maxLength);
            case ODDS_TUBES -> buildTubes(x, maxLength);
            case ODDS_JUMP -> buildJump(x, maxLength);
            case ODDS_CANNONS -> buildCannons(x, maxLength);
            default -> 0;
        };
    }
            ...
            for (int y = 0; y < height; y++) {
                if (y >= floor) {
                    ...
                    if (x == xCannon && y >= cannonHeight) {
                        if (y == cannonHeight) {
                            level.setBlock(x, y, (byte) (14));
                        } else if (y == cannonHeight + 1) {
                            level.setBlock(x, y, (byte) (14 + 16));
                        } else {
            ...
            for (int y = 0; y < height; y++) {
                if (y >= floor) {
                    ...
                    if ((x == xTube || x == xTube + 1) && y >= tubeHeight) {
                        int xPic = 10 + x - xTube;
                        if (y == tubeHeight) {
                            level.setBlock(x, y, (byte) (xPic));
                        } else {
                            level.setBlock(x, y, (byte) (xPic + 16));
                        }
                    }
                }
            }
                ...
                for (int x = x0 + 1 + s; x < x1 - 1 - e; x++) {
                    if (rocks) {
                        if (x != x0 + 1 && x != x1 - 2 && random.nextInt(3) == 0) {
                            if (random.nextInt(4) == 0) {
                                level.setBlock(x, floor - 4, (byte) (4 + 2 + 16));
                            } else {
                                level.setBlock(x, floor - 4, (byte) (4 + 1 + 16));
                            }
                        } else if (random.nextInt(2) == 0) {
                            if (random.nextInt(2) == 0) {
                                level.setBlock(x, floor - 4, (byte) (2 + 16));
                            } else {
                                level.setBlock(x, floor - 4, (byte) (1 + 16));
                            }
                        } else {
    ...
    private void blockify(Level level, boolean[][] blocks, int width, int height) {
        int to = switch (type) {
            case TYPE_CASTLE -> 4 * 2;
            case TYPE_UNDERGROUND -> 4 * 3;
            default -> 0;
        };
            ...
            for (int y = 0; y < height; y++) {
                ...
                if (b[0][0] == b[1][0] && b[0][1] == b[1][1]) {
                    ...
                    if (b[0][0]) {
                        ...
                        level.setBlock(x, y, (byte) (9 * 16 + to));
                    }
                    ...
                    if (b[0][0]) {
                        ...
                        if (b[0][1]) {
                            ...
                            level.setBlock(x, y, (byte) (8 * 16 + to));
                        }
                    }
                } else if (b[0][1] == b[1][1]) {
                    if (b[0][1]) {
                        ...
                        if (b[0][0]) {
                            ...
                            level.setBlock(x, y, (byte) (10 * 16 + to));
                        }
                    }
                } else {
                    level.setBlock(x, y, (byte) (16 + to));
                }
            }
        }
    }
