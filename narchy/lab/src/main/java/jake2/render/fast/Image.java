...
public abstract class Image extends Main {
    ...
    private static final gltmode_t[] gl_alpha_modes =
            {
    ...
    private static final gltmode_t[] gl_solid_modes =
            {
...
//    private final Exception gotoBreakOut = new Exception();
//    private final Exception gotoDone = gotoBreakOut;
	...
	=============
	*/
    private byte[] LoadTGA(String name, Dimension dim) {
	...
	*/
    ...
    private static final int[] p1 = new int[1024];
    private static final int[] p2 = new int[1024];
    ...
    ================
    */
    private void GL_LightScaleTexture(int[] in, int inwidth, int inheight, boolean only_gamma) {
        if (only_gamma) {
    ...
    */
    ...
    ===============
    */
    private void GL_BuildPalettedTexture(ByteBuffer paletted_texture, int[] scaled, int scaled_width, int scaled_height) {
	...
	*/
    ...
    private boolean GL_Upload8(byte[] data, int width, int height, boolean mipmap, boolean is_sky) {
    ...
    */
    ...
    private final Map imageCache = new HashMap(MAX_GLTEXTURES);
    ...
    */
    ...
    private final IntBuffer texnumBuffer = Lib.newIntBuffer(1);
