...
public abstract class Model extends Surf {
	...
	*/
	 ...
	 */
	private static final int MODEL_BUFFER_SIZE = 50000;
	private static final FloatBuffer globalModelTextureCoordBuf = Lib.newFloatBuffer(MODEL_BUFFER_SIZE * 2);
	private static final ShortBuffer globalModelVertexIndexBuf = Lib.newShortBuffer(MODEL_BUFFER_SIZE);
	
	private static void precompileGLCmds(qfiles.dmdl_t model) {
	...
	private static void resetModelArrays() {
