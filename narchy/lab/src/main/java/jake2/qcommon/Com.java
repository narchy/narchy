...
public final class Com
{
	...
	private static final String[] com_argv= new String[Defines.MAX_NUM_ARGVS];
	...
	private static StringBuffer rd_buffer;
	...
	private static final char[] com_token= new char[Defines.MAX_TOKEN_CHARS];
	 ...
	 * CRC table. 
	 */
	private static final byte[] chktbl = { (byte) 0x84, (byte) 0x47, (byte) 0x51, (byte) 0xc1,
	...
	private static final byte[] chkb = new byte [60 + 4];
