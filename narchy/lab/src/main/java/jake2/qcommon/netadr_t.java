...
public class netadr_t {
    ...
    public InetAddress getInetAddress() throws UnknownHostException {
        return switch (type) {
            case Defines.NA_BROADCAST -> InetAddress.getByName("255.255.255.255");
            case Defines.NA_LOOPBACK -> InetAddress.getByName(null);
            case Defines.NA_IP -> InetAddress.getByAddress(ip);
            default -> null;
        };
    }
