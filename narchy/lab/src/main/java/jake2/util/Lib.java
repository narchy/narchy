...
public class Lib {
    ...
    private static final byte[] nullfiller = new byte[8192];
     ...
     */
    private static char readableChar(int i) {
        if ((i < 0x20) || (i > 0x7f))
            return '.';
        else
            return (char) i;
...
//    }
    ...
    public static FloatBuffer newFloatBuffer(int numElements) {
        return newByteBuffer(numElements * SIZEOF_FLOAT).asFloatBuffer();
    }
//
//    public static FloatBuffer newFloatBuffer(int numElements, ByteOrder order) {
//        return newByteBuffer(numElements * SIZEOF_FLOAT, order).asFloatBuffer();
//    }

    public static IntBuffer newIntBuffer(int numElements) {
        return newByteBuffer(numElements * SIZEOF_INT).asIntBuffer();
    }

    public static IntBuffer newIntBuffer(int numElements, ByteOrder order) {
		return newByteBuffer(numElements * SIZEOF_INT, order).asIntBuffer();
    }

    public static ShortBuffer newShortBuffer(int numElements) {
		return newByteBuffer(numElements * SIZEOF_SHORT).asShortBuffer();
    }
//
//    public static ShortBuffer newShortBuffer(int numElements, ByteOrder order) {
//		return newByteBuffer(numElements * SIZEOF_SHORT, order).asShortBuffer();
//    }

    public static ByteBuffer newByteBuffer(int numElements) {
        return newByteBuffer(numElements, ByteOrder.nativeOrder());
    }

    public static ByteBuffer newByteBuffer(int numElements, ByteOrder order) {
        return ByteBuffer.allocateDirect(numElements).order(order);
    }
}