...
public class ALEPipes {
    ...
    private final boolean useRLE = true;
    ...
    private void sendAction(int act) {
     ...
     *
     */
    private void readRLData(String line) {
        // Parse RL data
    ...
    /** Reads the console RAM from a string 
      ...
      */
    private void readRam(String line) {
        int offset = 0;
     ...
     */
    private void readScreenMatrix(CharSequence line) {
        int ptr = 0;
    ...
    private static int byteAt(CharSequence line, int ptr) {
    ...
    private void readScreenRLE(CharSequence line) {
        int ptr = 0;
