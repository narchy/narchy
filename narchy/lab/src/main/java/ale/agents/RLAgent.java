...
public class RLAgent extends AbstractAgent {
    private final int numActions = Actions.numPlayerActions;
    ...
    private final SarsaLearner learner;

    /** The action selected by the learner */
    private int learnerAction;
    /** A history of recent screen data */
    private final FrameHistory history;

    /** Keeping track of how many episodes we've played */
    private int episodeNumber;
    private final int maxNumEpisodes = 10;
     ...
     *
     */
    private RLAgent(boolean useGUI, String pipesBasename) {
     ...
     *
     */
    private void rlStep(ScreenMatrix image, ConsoleRAM ram, RLData rlData) {
    ...
    private void episodeEnd(double reward) {
