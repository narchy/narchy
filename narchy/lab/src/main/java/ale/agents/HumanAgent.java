...
public class HumanAgent extends AbstractAgent {
     ...
     *  @see MovieGenerator
     */
    private final String exportFrameBasename = "frames/frame_";
    ...
    private boolean displayedGameOver = false;
    ...
    private HumanAgent(boolean useGUI, String namedPipesName, boolean exportFrames) {
