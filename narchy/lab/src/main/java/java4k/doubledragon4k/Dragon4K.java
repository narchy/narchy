...
public class Dragon4K extends GamePanel {

	public static void main(String[] args) throws Throwable {
	  JFrame frame = new JFrame("Double Dragon 4K");
	  frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	  Dragon4K applet = new Dragon4K();
						...
						for (x = 0; x < width; x++) {
							...
							if (z == 3) {
                                ...
                                switch (i) {
                                    ...
                                    case SPRITE_HAND -> pixels[x] = z == 0 ? 0x502000 : z == 2 ? 0xF8B8A8 : 0xB87070;
                                    case SPRITE_MEAT -> pixels[x] = z == 0 ? 0x000000 : z == 2 ? 0xEEECD3 : 0xA6674D;
                                    case int i1 when i1 >= SPRITE_MAN_HEAD_1 && i1 < SPRITE_WINDOW ->
                                            pixels[x] = z == 0 ? 0x000000 : z == 2 ? flesh : Color.HSBtoRGB(0.16f + (colors & 7) / 8f, 0.64f, 1);
                                    case int i1 when i1 >= SPRITE_WINDOW ->
                                            pixels[x] = z == 0 ? 0x000000 : Color.HSBtoRGB(cloth, 0.73f, z == 1 ? 0.5f : 1);
                                    case int i1 when i1 >= SPRITE_WINDOW ->
                                            pixels[x] = z == 0 ? 0x000000 : Color.HSBtoRGB(cloth, 0.73f, z == 1 ? 0.5f : 1);
                                    case int i1 when i1 <= SPRITE_WOMAN_LEGS_3 ->
