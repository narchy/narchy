...
//    /** edge to (target) node spread rate.  0 to disable */
//    public final FloatRange edgeToTargetSpread = new FloatRange(0, 0, 2);

//    /** derive task priority to premise task link(s).  0 to disable */
//    public final FloatRange deriveTaskReflect = new FloatRange(0, 0, 1);
