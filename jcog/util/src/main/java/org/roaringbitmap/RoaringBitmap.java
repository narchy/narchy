...
//      return o instanceof RoaringBitmap srb &&
//              srb.highLowContainer.equals(this.highLowContainer);
//  }
//
//  /**
...
//   */
//  @Override
//  public final long getLongCardinality() {
...
//    int size = 0;
//    RoaringArray h = this.highLowContainer;
//    int hs = h.size;
//    for (int i = 0; i < hs; i++)
//      size += h.values[i].getCardinality();
//    return size;
//  }
//
//  /**
