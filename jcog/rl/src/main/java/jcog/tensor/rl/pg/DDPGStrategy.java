...
import jcog.tensor.rl.pg.PGBuilder.DeterministicPolicy;
import jcog.tensor.rl.pg.PGBuilder.QNetwork;
...
public class DDPGStrategy extends OffPolicyStrategy {
    ...
    public static DDPGStrategy ddpgStrategy(int i, int o, PGBuilder.ActionConfig actionConfig, PGBuilder.NetworkConfig policyNetConfig, PGBuilder.NetworkConfig valueNetConfig, PGBuilder.MemoryConfig memoryConfig, PGBuilder.HyperparamConfig hyperparams) {
        ...
        var ddpgPolicyOpt = ddpgPolicyNetConfig.optimizer().buildOptimizer();
        ...
        var ddpgCriticOpt = valueNetConfig.optimizer().buildOptimizer();
