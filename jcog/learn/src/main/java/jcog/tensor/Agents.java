...
import jcog.tensor.experimental.ReinforceDNC;
...
import jcog.tensor.rl.dqn.*;
import jcog.tensor.rl.dqn.replay.SimpleReplay;
import jcog.tensor.rl.misc.PopulationPolicy;
import jcog.tensor.rl.misc.SpikingPolicy;
...
//                .gradClamp(1)
    ...
    public static Agent A2C(int i, int o) {
        float s = 1;
        return new A2C(i, o, round(i * o * s), round(i * s), 3).agent();
    }
