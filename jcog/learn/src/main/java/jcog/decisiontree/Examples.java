...
public class Examples {
  static class Example {
    ...
    Example(String[] attributeNames, String[] attributeValues,
                   boolean classifier) {
    ...
    Example(Map<String, String> attributes, boolean classifier) {
      this.classifier = classifier;
  ...
  public Map<String, Set<String> > extractDecisions() {
    Map<String, Set<String> > decisions = new HashMap<>();
