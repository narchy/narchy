...
public class SRN  {
    ...
    protected final double[][] firstConnectionLayer;
    protected final double[][] recurrentConnectionLayer;
    protected final double[][] secondConnectionLayer;
    protected final double[] hiddenNeurons;
    protected final double[] hiddenNeuronsCopy;
