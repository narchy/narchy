...
class AxialSplitTest {
    ...
    private static final RTree2DTest.DefaultSplits TYPE = RTree2DTest.DefaultSplits.AXIAL;
    ...
    void randomEntryTest(int maxLeaf) {
        ...
        Stats stats = rTree.stats();
        assertEquals(0, Math.abs(entryCount - stats.size()), () -> "Unexpected number of entries in " + TYPE + " split tree: " + stats.size() + " entries - expected: " + entryCount + " actual: " + stats.size());
