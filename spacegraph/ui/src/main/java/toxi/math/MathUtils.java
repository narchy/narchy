...
public enum MathUtils {
    ...
    public static final float THIRD = 1.0f / 3;
     ...
     * PI*1.5
     */
    private static final float THREE_HALVES_PI = TWO_PI - HALF_PI;
     ...
     */
    private static final float RAD2DEG = 180 / PI;

    private static final float SHIFT23 = 1 << 23;

    private static final float INV_SHIFT23 = 1.0f / SHIFT23;
    private static final double SIN_A = -4.0d / (PI * PI);

    private static final double SIN_B = 4.0d / PI;
    private static final double SIN_P = 9.0d / 40;
    /**
...
//    }
    ...
    public static float cos(float theta) {
        return (float)Math.sin(theta + HALF_PI);
    }
...
//    }
    ...
    public static float roundTo(float val, float prec) {
        return (float) (Math.floor(val / prec + 0.5) * prec);
    }
