...
class ConstraintPersistentData {
    ...
    public void reset() {
        appliedImpulse = 0.0f;
        prevAppliedImpulse = 0.0f;
        accumulatedTangentImpulse0 = 0.0f;
        accumulatedTangentImpulse1 = 0.0f;

        jacDiagABInv = 0.0f;
        jacDiagABInvTangent0 = 0.0f;
        jacDiagABInvTangent1 = 0.0f;
        persistentLifeTime = 0;
        restitution = 0.0f;
        friction = 0.0f;
        penetration = 0.0f;
        frictionWorldTangential0.set(0.0f, 0.0f, 0.0f);
        frictionWorldTangential1.set(0.0f, 0.0f, 0.0f);

        frictionAngularComponent0A.set(0.0f, 0.0f, 0.0f);
        frictionAngularComponent0B.set(0.0f, 0.0f, 0.0f);
        frictionAngularComponent1A.set(0.0f, 0.0f, 0.0f);
        frictionAngularComponent1B.set(0.0f, 0.0f, 0.0f);

        angularComponentA.set(0.0f, 0.0f, 0.0f);
        angularComponentB.set(0.0f, 0.0f, 0.0f);
