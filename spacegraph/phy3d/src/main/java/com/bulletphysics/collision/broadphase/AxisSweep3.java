...
public class AxisSweep3 extends AxisSweep3Internal {
	...
	protected static class HandleImpl extends Handle {
		...
		public void setMinEdges(int edgeIndex, int value) {
			switch (edgeIndex) {
				case 0 -> minEdges0 = (short) value;
				case 1 -> minEdges1 = (short) value;
				case 2 -> minEdges2 = (short) value;
			}
		}
		...
		public void setMaxEdges(int edgeIndex, int value) {
			switch (edgeIndex) {
				case 0 -> maxEdges0 = (short) value;
				case 1 -> maxEdges1 = (short) value;
				case 2 -> maxEdges2 = (short) value;
			}
		}
	}
