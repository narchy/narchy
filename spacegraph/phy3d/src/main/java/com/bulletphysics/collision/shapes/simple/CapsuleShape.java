...
public class CapsuleShape extends ConvexInternalShape {
    ...
    public Vector3f localGetSupportingVertexWithoutMargin(Vector3f vec0, Vector3f out) {
...

        {
            ...
            VectorUtil.coord(pos, getUpAxis(), getHalfHeight());
    ...
    public void calculateLocalInertia(float mass, Vector3f inertia) {
        ...
        VectorUtil.coord(halfExtents, getUpAxis(), radius + getHalfHeight());
    ...
    public void getAabb(Transform t, Vector3f aabbMin, Vector3f aabbMax) {
        ...
        VectorUtil.coord(halfExtents, upAxis, getRadius() + getHalfHeight());
     ...
     * @author jezek2
     */
    public static class CapsuleShapeX extends CapsuleShape {
     ...
     * @author jezek2
     */
    public static class CapsuleShapeZ extends CapsuleShape {
