...
public class BroadphasePair {
	...
	public static final Comparator<BroadphasePair> broadphasePairSortPredicate = (a, b) -> {
		if (a == b) return 0;
		// JAVA TODO:
		int ap0 = a.pProxy0.getUid();
		int ap1 = a.pProxy1.getUid();
		int bp0 = b.pProxy0.getUid();
		int bp1 = b.pProxy1.getUid();
		boolean result = ap0 > bp0 ||
				(ap0 == bp0 && ap1 > bp1) ||
				(ap0 == bp0 && ap1 == bp1 /*&& a.algorithm > b.m_algorithm*/);
		return result ? -1 : 1;
	};
