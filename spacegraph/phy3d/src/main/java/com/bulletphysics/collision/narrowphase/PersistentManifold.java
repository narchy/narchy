...
public class PersistentManifold {
	...
	{
		Arrays.setAll(pointCache, i -> new ManifoldPoint());
	}
...
//		m_pointCache[index] = m_pointCache[lastUsedIndex];
		if (index != lastUsedIndex) {
			...
			pointCache[lastUsedIndex].appliedImpulse = 0.0f;
			pointCache[lastUsedIndex].lateralFrictionInitialized = false;
			pointCache[lastUsedIndex].appliedImpulseLateral1 = 0.0f;
			pointCache[lastUsedIndex].appliedImpulseLateral2 = 0.0f;
